...
public class ListDisplayer {
	...
	/////////////////////////////////////////////////////////////////////////
	//static
	private static int defaultLinePerPage = 6;
	private static String leftSign = "[ ◀◀ ]";
	private static String rightSign = "[ ▶▶ ]";
	private static String pageSign = "  &2%current%&7/&2%total%  ";
