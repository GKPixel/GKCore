...
public class GKPhysics {
    ...
    public static Vector LocationVectorFromString(String s) {
        ...
        final double x = Double.parseDouble(parts[3].replace(",y", ""));
        final double y = Double.parseDouble(parts[4].replace(",z", ""));
        final double z = Double.parseDouble(parts[5].replace(",pitch", ""));
